...
movie_reviews = pd.read_csv('C:/Users/nasba/Downloads//Emo_Eval/SSEC.csv', names=['review','sentiment'])

'''
######
df = pd.read_csv("ssec_unique_train.txt",delimiter=',')
df.to_csv('training_ssec.csv',header=['review','sentiment'])
train = pd.read_csv('C:/Users/nasba/Downloads//Emo_Eval/training_ssec.csv', names=['review','sentiment'])


df1 = pd.read_csv("ssec_unique_test.txt",delimiter=',')
df1.to_csv('testing_ssec.csv',header=['review','sentiment'])
test = pd.read_csv('C:/Users/nasba/Downloads//Emo_Eval/testing_ssec.csv', names=['review','sentiment'])

movie_reviews = pd.concat([train,test], ignore_index=True)
movie_reviews.to_csv('SSEC.csv',index=False)
#######

        
train = pd.read_csv("C:/Users/nasba/Downloads//Emo_Eval/train_ssec.csv", header=None)
train.rename(columns={0: 'review', 1: 'sentiment'}, inplace=True)
test = pd.read_csv("C:/Users/nasba/Downloads//Emo_Eval/test_ssec.csv",names=['review', 'sentiment'])
'''
...
glove_file = open('C:/Users/nasba/Downloads/Embeddings/News/W-Skip-POS.txt', encoding="utf8")
